...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || 'Salman Patwary;Spllc;0;https://telegra.ph/file/9323f5a2e1c1f268a462b.jpg;https://chat.whatsapp.com/FHGdpEaBCi78Xqyyziuclp',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA||"Spllc Bot",
    BOT_NAME: process.env.BOT_NAME || 'Spllc Bot',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭𝑺𝜣𝑼𝑹𝛢𝑽𝑲𝑳¹¹ꫂ;Spllc MD bot;https://www.linkpicture.com/q/rgnk.jpg' : process.env.AUDIO_DATA,
